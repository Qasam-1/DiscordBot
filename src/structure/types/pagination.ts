...
export interface PaginationItem extends BaseMessageOptions {
  ...
  middleButton?: ButtonOptions;
}

export type PaginationInteractions = CommandInteraction | MessageComponentInteraction | ContextMenuCommandInteraction;

export type PaginationSendTo = PaginationInteractions | Message | Exclude<TextBasedChannel, PartialGroupDMChannel>;
...
export interface NavigationButtonOptions {
  ...
  /**
   * Middle button options (custom button between navigation buttons)
   */
  middle?: ButtonOptions;
...
export interface PaginationOptions extends BasicPaginationOptions {
  ...
  /**
   * Enable auto-refresh functionality that allows external components
   * to force refresh this pagination instance
   */
  autoRefresh?: boolean;
}
