import { Builder, JSX as CanvacordJSX, Font, FontFactory, loadImage, StyleSheet, type ImageSource } from 'canvacord';
...
const Crown = () => {
  return CanvacordJSX.createElement(
    ...
    CanvacordJSX.createElement('path', {
...
export class LeaderboardBuilder extends Builder<EconomyLeaderboardProps> {
  ...
  public renderDefaultPlayers(players: JSX.Element[]) {
    return CanvacordJSX.createElement('div', { className: 'mt-4 flex flex-col items-center justify-center w-[95%]' }, players as unknown as JSX.Element);
  }
  ...
  public async renderDefaultTop({ avatar, displayName, bank, rank, username, wallet }: EconomyLeaderboardProps['players'][number]) {
    ...
    return CanvacordJSX.createElement(
      ...
      crown
        ? CanvacordJSX.createElement('div', { className: 'absolute flex -top-16' }, Crown() as unknown as JSX.Element)
      ...
      CanvacordJSX.createElement(
        ...
        avatar
          ...
          : CanvacordJSX.createElement('div', { className: StyleSheet.cn(`border-[3px] border-[${currentColor}] flex rounded-full h-18 w-18`) }),
        CanvacordJSX.createElement(
          'div',
          {
      ...
      CanvacordJSX.createElement(
        ...
        CanvacordJSX.createElement('h1', { className: 'text-white text-base font-extrabold m-0' }, displayName as unknown as JSX.Element),
        CanvacordJSX.createElement('h2', { className: 'text-[#9ca0a5] text-xs font-thin m-0 mb-2' }, `@${username}` as unknown as JSX.Element),
        CanvacordJSX.createElement(
          'h4',
  ...
  public async renderDefaultPlayer({ avatar, displayName, bank, rank, username, wallet }: EconomyLeaderboardProps['players'][number]) {
    return CanvacordJSX.createElement(
      ...
      CanvacordJSX.createElement(
        ...
        avatar
          ? CanvacordJSX.createElement('img', { src: avatar, className: 'rounded-full h-14 w-14 mr-2', alt: 'avatar' })
          : CanvacordJSX.createElement('div', { className: 'rounded-full h-14 w-14 mr-2 flex' }),
        CanvacordJSX.createElement(
          'div',
          { className: 'flex flex-col items-start justify-center' },
          CanvacordJSX.createElement('h1', { className: 'text-white font-extrabold text-lg m-0' }, displayName as unknown as JSX.Element),
          CanvacordJSX.createElement('h4', { className: 'text-[#9ca0a5] font-medium text-base m-0' }, `@${username}` as unknown as JSX.Element)
        )
      ),
      CanvacordJSX.createElement(
        'div',
        ...
        CanvacordJSX.createElement(
          ...
          CanvacordJSX.createElement('span', { className: 'text-white ml-1' }, `#${rank}` as unknown as JSX.Element)
        ),
        CanvacordJSX.createElement(
          'h4',
          { className: 'text-[#9ca0a5] text-sm m-0' },
          this.options.get('text').bank as unknown as JSX.Element,
          CanvacordJSX.createElement('span', { className: 'text-white ml-1' }, fixed(bank, this.options.get('abbreviate')) as unknown as JSX.Element)
        ),
        CanvacordJSX.createElement(
          'h4',
          { className: 'text-[#9ca0a5] text-sm m-0' },
          this.options.get('text').wallet as unknown as JSX.Element,
          CanvacordJSX.createElement('span', { className: 'text-white ml-1' }, fixed(wallet, this.options.get('abbreviate')) as unknown as JSX.Element)
        )
      )
    ) as JSX.Element;
  }
  ...
  public async renderDefaultVariant() {
    ...
    return CanvacordJSX.createElement(
      ...
      background
        ? CanvacordJSX.createElement('img', { src: background.toDataURL(), className: 'absolute top-0 left-0 h-full w-full', alt: 'background' })
        : CanvacordJSX.createElement('div', { className: 'hidden' }),
      CanvacordJSX.createElement(
        'div',
        ...
        options.header && headerImg
          ? CanvacordJSX.createElement(
              ...
              CanvacordJSX.createElement('img', { src: headerImg.toDataURL(), className: 'rounded-full w-16 h-w-16', alt: 'header' }),
              CanvacordJSX.createElement('h1', { className: 'text-white text-xl font-extrabold m-0 mt-2' }, options.header.title as unknown as JSX.Element),
              CanvacordJSX.createElement('h2', { className: 'text-white text-sm font-medium m-0' }, options.header.subtitle as unknown as JSX.Element)
            )
          : CanvacordJSX.createElement('div', { className: 'hidden' }),
        CanvacordJSX.createElement(
          'div',
  ...
  public async renderHorizontalPlayer({ avatar, displayName, bank, rank, username, wallet }: EconomyLeaderboardProps['players'][number]) {
    return CanvacordJSX.createElement(
      ...
      CanvacordJSX.createElement(
        ...
        avatar
          ? CanvacordJSX.createElement('img', { src: avatar, width: 50, height: 50, className: 'rounded-full flex', alt: 'avatar' })
          : CanvacordJSX.createElement('div', { width: 50, height: 50, className: 'rounded-full flex', alt: 'avatar' }),
        CanvacordJSX.createElement(
          'div',
          { className: 'flex flex-col justify-center ml-3' },
          CanvacordJSX.createElement('h1', { className: 'text-white text-lg font-extrabold m-0' }, displayName as unknown as JSX.Element),
          CanvacordJSX.createElement('h2', { className: 'text-[#9ca0a5] text-base font-medium m-0 mb-2' }, `@${username}` as unknown as JSX.Element)
        )
      ),
      CanvacordJSX.createElement(
        'div',
  ...
  public async renderHorizontalVariant() {
    ...
    return CanvacordJSX.createElement(
      ...
      background
        ? CanvacordJSX.createElement('img', { src: background.toDataURL(), className: 'flex absolute top-0 left-0', alt: 'background' })
        : CanvacordJSX.createElement('div', { className: 'hidden' }),
      CanvacordJSX.createElement(
        'div',
        { className: 'flex justify-center w-full m-0 my-5' },
        options.header && headerImg
          ? CanvacordJSX.createElement('img', { src: headerImg.toDataURL(), width: 49.53, height: 50.44, className: 'flex rounded-full mr-3', alt: 'header' })
          : CanvacordJSX.createElement('div', { className: 'hidden' }),
        CanvacordJSX.createElement(
          'div',
          { className: 'flex flex-col items-center justify-center' },
          options.header?.title
            ? CanvacordJSX.createElement('div', { className: 'text-white font-semibold text-2xl flex' }, options.header.title as unknown as JSX.Element)
            : CanvacordJSX.createElement('div', { className: 'hidden' }),
          options.header?.subtitle
            ? CanvacordJSX.createElement('div', { className: 'text-gray-300 font-medium flex' }, options.header.subtitle as unknown as JSX.Element)
            : CanvacordJSX.createElement('div', { className: 'hidden' })
        )
      ),
      CanvacordJSX.createElement(
        ...
        ...processedPlayerGroups.map((renderedPlayers) =>
          CanvacordJSX.createElement('div', { className: 'flex flex-col flex-1', style: { gap: '6' } }, ...renderedPlayers)
        )
      )
    ) as JSX.Element;
  }
