...
import { Builder, Font, FontFactory, JSX as CanvacordJSX, loadImage, StyleSheet, type ImageSource } from 'canvacord';
    ...
    return CanvacordJSX.createElement(
      ...
      CanvacordJSX.createElement(
        ...
        avatar
          ...
          : CanvacordJSX.createElement('div', { className: StyleSheet.cn(`border-[3px] border-[${currentColor}] rounded-full h-18 w-18`) }),
        CanvacordJSX.createElement(
          'div',
          {
    ...
    return CanvacordJSX.createElement(
      ...
      CanvacordJSX.createElement(
        ...
        avatar
          ...
          : CanvacordJSX.createElement('div', { className: 'rounded-full h-14 w-14 mr-2' }),
        CanvacordJSX.createElement(
          'div',
      ...
      CanvacordJSX.createElement(
        ...
        CanvacordJSX.createElement(
          ...
          CanvacordJSX.createElement('span', { className: 'text-white ml-1' }, fixed(level, this.options.get('abbreviate')) as unknown as JSX.Element)
        ),
        CanvacordJSX.createElement(
          'h4',
          { className: 'text-[#9ca0a5] text-sm m-0' },
          this.options.get('text').xp as unknown as JSX.Element,
          CanvacordJSX.createElement('span', { className: 'text-white ml-1' }, fixed(xp, this.options.get('abbreviate')) as unknown as JSX.Element)
        )
      )
    ) as JSX.Element;
  }
